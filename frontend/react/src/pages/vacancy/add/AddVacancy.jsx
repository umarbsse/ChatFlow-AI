...
function AddVacancy() {
  const { formData, saving, successMessage, errorMessage, errors, handleChange, handleSubmit, resetForm } = useVacancyForm();
      ...
      <div className="vacancy-container">
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="vacancy-actions">
            <button type="button" className="btn btn-light rounded-pill px-4" onClick={resetForm} disabled={saving}>Clear Form</button>
